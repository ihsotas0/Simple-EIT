...
class SimpleEIT:
    ...
    #     self.set_mux(0, 0)
    #     v_return[1] = self.dm.get_voltage()

    #     # Configuration 3 (S is A-D)
    #     self.set_mux(0, 2)
    #     v_return[2] = self.dm.get_voltage()

    #     # Configuration 5 (S is B-D)
    #     self.set_mux(1, 2)
    #     v_return[4] = self.dm.get_voltage()

    #     # Configuration 4 (S is B-C)
    #     self.set_mux(1, 0)
    #     v_return[3] = self.dm.get_voltage()

    #     # Configuration 6 (S is C-D)
    #     self.set_mux(2, 1)
    #     v_return[5] = self.dm.get_voltage()

    #     # Configuration 1 (S is A-B)
    #     self.set_mux(3, 3)
    #     v_return[0] = self.dm.get_voltage()
    ...
    def run(self):
        ...
        self.ani = FuncAnimation(
            self.fig,
            self.update,
            interval=100,  # IMPORTANT: Update period in ms
            blit=True,
